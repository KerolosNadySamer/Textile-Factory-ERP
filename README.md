...
This project follows a strict data preservation rule: new features, migrations, seeders, and workflow changes must not delete or reset existing operational data.

Before adding changes, read:
